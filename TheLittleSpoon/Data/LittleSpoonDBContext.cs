    ...
    public class LittleSpoonDBContext : IdentityDbContext<Models.ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 10, 13, 15, 50, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 5, 22, 8, 10, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 5, 22, 10, 30, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 5, 22, 22, 40, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 5, 22, 3, 55, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 1, 28, 16, 25, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 3, 9, 18, 12, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 5, 22, 8, 5, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 1, 28, 14, 00, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 5, 22, 20, 30, 00),
            ...
            modelBuilder.Entity<Article>().HasData(new Article
            {
                ...
                DateCreated = new DateTime(2020, 12, 15, 21, 30, 00),
